...
public class EchelonLayoutManager extends LinearLayoutManager {
    ...
    public EchelonLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
    }

    public EchelonLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        mItemViewWidth = (int) (getHorizontalSpace());
        mItemViewHeight = (int) (getVerticalSpace() * 0.8);
