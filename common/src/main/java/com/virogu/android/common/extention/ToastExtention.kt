...
fun Context.toast(
    ...
    if (singleInstance) {
        toast?.cancel()
        toast = Toast.makeText(applicationContext, msg, duration).also {
            it.show()
        }
    } else {
        Toast.makeText(applicationContext, msg, duration).also {
            it.show()
        }
    }
}
...
fun Context.toast(
    ...
    if (singleInstance) {
        toast?.cancel()
        toast = Toast.makeText(applicationContext, getString(msg), duration).also {
            it.show()
        }
    } else {
        Toast.makeText(applicationContext, getString(msg), duration).also {
            it.show()
        }
    }
}
